import type { CVData, Skill, Experience, Education } from './types';
...
const historyCs: { experiences: Experience[], educations: Education[] } = {
  "experiences": [
    ...
    },
    {
      ...
      "description": "Zodpovědnost za údržbu a vývoj klíčových funkcí hlavní frontendové aplikace Suitest s důrazem na vysoký výkon a bezproblémový uživatelský zážitek.",
      "projects": [
    ...
    },
    {
      ...
      "period": "2011 - 2012",
      "description": "Proaktivně jsem identifikoval a vyřešil hlavní problém ve vývojovém workflow. Refaktoroval jsem zastaralý proces sestavení XML/XSLT, čímž jsem zkrátil dobu kompilace z 5 minut na pouhých 10 sekund na změnu, což výrazně zvýšilo produktivitu týmu.",
      "projects": [
    ...
    },
    {
      ...
      "period": "2007 - 2011",
      "description": "Tvořil a udržoval jsem webové magazíny jako root.cz, lupa.cz, vitalia.cz, podnikatel.cz a mesec.cz.",
      "projects": [
